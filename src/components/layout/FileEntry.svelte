<script lang="ts">
    ...
    $: canShowTarget = $preferences.langSelect.displayMode == 'target' || $preferences.langSelect.displayMode == 'both';
...
<button on:click={() => select()} on:keydown={() => select()} class:selected={$selectedFile === file}>
    ...
    <div class="progress">
        <div class="progress-bar-wrapper">
            ...
            <div class="progress-bar" class:selected={$selectedFile === file} style="width:{percentage * 100}%;"></div>
        </div>
