...
<OptionEntry>
    <div slot="key">
        {#if $selectedFile.isSource}
            <p class="note">
                You are creating a translation on all files translating from {$selectedFile.sourceLanguage}
            </p>
        {:else}
            <p class="note">
                You are creating a translation in this file. ({$selectedFile.targetLanguage})<br
