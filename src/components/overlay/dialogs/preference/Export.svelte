...
<SettingsEntry>
    ...
    <div slot="value">
        ...
        <br>
        No. of space <input type="number" min=1 size=4 bind:value={$preferences.export.spaceChar}>
        {/if}
    </div>
</SettingsEntry>
...
<SettingsEntry>
    ...
    <p slot="description">Behaviour when exporting empty translation in XLIFF format</p>
    <div slot="value">
