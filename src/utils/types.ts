...
export class Project {
  ...
  getOriginatingFile(file: TranslationFile) {
    return this.files.filter(
      (e) => e.sourceLanguage === file.sourceLanguage,
    )[0];
  }
}
...
export const Translators = {
  GOOGLE_TRANSLATE: new Translator(
    "Google Translate",
    "https://translate.google.com/?sl=auto&tl={targetLang}&q={text}",
    ["zh-CN", "zh-CN"],
    ["zh-TW", "zh-TW"],
    ["zh-HK", "zh-TW"],
  ),
  DEEPL_TRANSLATE: new Translator(
    "DeepL Translate",
    "https://www.deepl.com/translator?#{srcLang}/{targetLang}/{text}",
  ),
  YANDEX_TRANSLATE: new Translator(
    "Yandex Translate",
    "https://translate.yandex.com/?source_lang={srcLang}&target_lang={targetLang}&text={text}",
  ),
} as const;
